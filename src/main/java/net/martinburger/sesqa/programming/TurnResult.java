...
public class TurnResult {
    ...
    public boolean equals(Object object) {
        ...
        return year == that.year && newResidents == that.newResidents
                ...
                && ateByRates == that.ateByRates && starvedPercentage == that.starvedPercentage
    ...
    @Override
    public int hashCode() {
        return Objects.hash(super.hashCode(), name, year, newResidents, bushelsHarvested, residents,
                bushels, starved, acres, ateByRates, starvedPercentage);
    }
